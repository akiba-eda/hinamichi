...
enum DisasterType {
  ...
  /// 一覧の見出し。「周辺の避難場所」だと、災害を切り替えても同じ見出しのまま
  /// 中身だけ入れ替わり、何が起きたのか分からない。
  String get shelterHeading => '$labelのときに逃げる場所';

  /// なぜ顔ぶれが変わるのかの一言。
  ///
  /// 指定緊急避難場所は災害種別ごとに別々に指定されていて、同じ建物でも
  /// 「地震ならよいが津波では駄目」ということが起きる。件数だけ変わっても
  /// 理由が分からないと、選び直しの判断ができない。
  String get shelterNote => switch (this) {
        earthquake => '揺れから身を守る場所。倒壊や火災から離れられる広い場所が選ばれています',
        tsunami => '津波から逃げる場所。浸水想定の中にある場所は指定されないので、高台や高い建物になります',
        flood || heavyRain || stormSurge => '浸水から逃げる場所。浸水想定の中にある場所は指定されません',
        landslide => '土砂から逃げる場所。土砂災害警戒区域の中にある場所は指定されません',
      };
}
